"""
Django settings for rrrsa_42887 project.
...
WSGI_APPLICATION = 'rrrsa_42887.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rrrsa_42887 API",
    "DESCRIPTION": "API documentation for rrrsa_42887 App",
    "VERSION": "v1",
}
